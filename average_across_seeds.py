...
for path in paths:
    ...
    for field in average_row:
        ...
        if field == "ID":
            pass
        # If the field has subfields, average across all of them
...
for field in new_average_row:
    # If the field has subfields, average across all of them
    if isinstance(new_average_row[field], dict):
...
# Setup
folder_name = 'shared_encoder' # resp 'attention'
use_att = '_att_shared_encoder' # resp '_att'
paths = []
